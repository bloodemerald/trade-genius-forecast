    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#9b87f5] focus-visible:ring-offset-1 focus-visible:border-[#9b87f5]",
          "hover:border-[#9b87f5]/50 transition-colors duration-200",
